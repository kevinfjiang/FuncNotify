...
def time_func(function=None, use_env=False, env_path=".env", NotifyMethod="Print", *dec_args, **dec_kwargs): 
    ...
    Args:
        function (func, optional): In case you want to use time_func as a pure decoratr without argumetns, 
        Alert serves as the function. Defaults to None.
    ...
    def time_function(func):
        ...
        def timer(*func_args, **func_kwargs):
            ...
            """           
            result = timer_base(func, NOTIFY_TYPE.get(NotifyMethod, NOTIFY_TYPE["Print"])(*dec_args, **dec_kwargs), 
