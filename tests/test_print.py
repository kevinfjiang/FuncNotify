...
class PrintTest(TestAbstract):
    ...
    def test_ENV(self, *args, **kwargs):
        time_func(self.wait_test, NotifyMethod="Print", update_env=True, use_env=True, *args, **kwargs)(**kwargs)
        self.confirm_dotenv("ALIVE")
    def test_DeadENV(self, *args, **kwargs):
        time_func(self.wait_test, NotifyMethod="Print", update_env=True, use_env=False, *args, **kwargs)(**kwargs)
